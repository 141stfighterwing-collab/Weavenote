                       ...
                       >
                           ...
                           <div className="flex items-center gap-1.5 pr-2">
                             ...
                             <button 
                               ...
                               className="opacity-0 group-hover/folder:opacity-100 focus-visible:opacity-100 focus-visible:ring-2 focus-visible:ring-primary-500 outline-none p-1 hover:text-red-500 transition-opacity"
                               title="Delete Folder"
