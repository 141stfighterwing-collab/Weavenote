        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl p-3 shadow-sm border border-slate-200 dark:border-slate-700">
            <div className="flex items-center justify-between mb-3 px-1">
                ...
                <div className="flex gap-1">
                    <button onClick={handlePrev} aria-label="Previous Month" className="p-1 hover:bg-slate-100 dark:hover:bg-slate-700 rounded focus-visible:ring-2 focus-visible:ring-primary-500 outline-none">
                        <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3"><path d="m15 18-6-6 6-6"/></svg>
                    </button>
                    <button onClick={handleNext} aria-label="Next Month" className="p-1 hover:bg-slate-100 dark:hover:bg-slate-700 rounded focus-visible:ring-2 focus-visible:ring-primary-500 outline-none">
    ...
    <aside className={`w-full lg:w-72 flex-shrink-0 space-y-6 ${className}`}>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl p-5 shadow-sm border border-slate-200 dark:border-slate-700">
        <div className="flex justify-between items-center mb-4 border-b border-slate-50 dark:border-slate-700 pb-2">
          ...
          <button onClick={() => setShowTemplateForm(prev => !prev)} aria-label="Add Template" className="p-1 rounded hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-500 transition-colors focus-visible:ring-2 focus-visible:ring-primary-500 outline-none" title="Add Template">
            ...
            return (
              <div key={template.id} className="border border-slate-200 dark:border-slate-700 rounded-lg overflow-hidden">
                <button
                  ...
                  className="w-full px-3 py-2 text-left text-xs font-bold flex items-center justify-between hover:bg-slate-50 dark:hover:bg-slate-700/40 text-slate-700 dark:text-slate-200 focus-visible:ring-2 focus-visible:ring-primary-500 ring-inset outline-none transition-all"
                >
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl p-5 shadow-sm border border-slate-200 dark:border-slate-700">
          <div className="flex justify-between items-center mb-4 border-b border-slate-50 dark:border-slate-700 pb-2">
            ...
            <button onClick={() => setIsCreatingFolder(true)} aria-label="Add Folder" title="Add Folder" className="p-1 rounded hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-500 transition-colors focus-visible:ring-2 focus-visible:ring-primary-500 outline-none">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
            </button>
          </div>
                       ...
                       >
                           ...
                           <div className="flex items-center gap-1.5 pr-2">
                             ...
                             <button 
                               ...
                               className="opacity-0 group-hover/folder:opacity-100 focus-visible:opacity-100 p-1 hover:text-red-500 transition-opacity focus-visible:ring-2 focus-visible:ring-red-500 outline-none rounded"
                               title="Delete Folder"
                             >
