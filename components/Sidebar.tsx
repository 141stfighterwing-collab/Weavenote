    ...
    <aside className={`w-full lg:w-72 flex-shrink-0 space-y-6 ${className}`}>
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl p-5 shadow-sm border border-slate-200 dark:border-slate-700">
        <div className="flex justify-between items-center mb-4 border-b border-slate-50 dark:border-slate-700 pb-2">
          ...
          <button aria-label="Add Template" onClick={() => setShowTemplateForm(prev => !prev)} className="p-1 rounded hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-500 transition-colors focus-visible:ring-2 focus-visible:ring-primary-500 outline-none" title="Add Template">
      ...
      <div className="bg-white dark:bg-slate-800 rounded-xl p-5 shadow-sm border border-slate-200 dark:border-slate-700">
          <div className="flex justify-between items-center mb-4 border-b border-slate-50 dark:border-slate-700 pb-2">
            ...
            <button aria-label="Add Folder" onClick={() => setIsCreatingFolder(true)} className="p-1 rounded hover:bg-slate-100 dark:hover:bg-slate-700 text-slate-500 transition-colors focus-visible:ring-2 focus-visible:ring-primary-500 outline-none">
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
            </button>
          </div>
                       ...
                       >
                           ...
                           <div className="flex items-center gap-1.5 pr-2">
                             ...
                             <button 
                               ...
                               className="opacity-0 group-hover/folder:opacity-100 focus-visible:opacity-100 p-1 hover:text-red-500 transition-opacity outline-none focus-visible:ring-2 focus-visible:ring-rose-500 rounded"
                               title="Delete Folder"
                             >
