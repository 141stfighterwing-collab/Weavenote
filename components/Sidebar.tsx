                       ...
                       >
                           ...
                           <div className="flex items-center gap-1.5 pr-2">
                             ...
                             <button 
                               ...
                               className="opacity-0 group-hover/folder:opacity-100 focus-visible:opacity-100 p-1 hover:text-red-500 transition-opacity focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:outline-none rounded"
                               title="Delete Folder"
