...
const NoteCard: React.FC<NoteCardProps> = ({ 
  ...
  const InputRenderer = useCallback((props: any) => {
      ...
      // Ensure we only hijack checkboxes
      ...
      return (
        <input 
            ...
            type="checkbox"
            disabled={readOnly}
            className="mt-1 h-3.5 w-3.5 rounded border-gray-300 text-primary-600 focus:ring-primary-500 cursor-pointer flex-shrink-0 align-middle mr-2"
            onChange={(e) => {
                // Prevent bubbling to note expand
                e.stopPropagation();
                // node.position.start.line gives the 1-based line number of the checkbox in markdown
