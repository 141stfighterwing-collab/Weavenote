        ...
        <div className="flex items-center justify-end gap-2 pt-4 border-t border-black/5">
            ...
            <div className="relative">
                <button
                  ...
                  className={`p-2 rounded-xl shadow-sm hover:scale-110 transition-transform ${isMatrix ? 'bg-[#39ff14]/10 text-[#39ff14]' : 'bg-white/50 text-slate-600'}`}
            ...
            <button
              ...
              className="p-2 bg-rose-500/20 text-rose-700 rounded-xl shadow-sm hover:scale-110 transition-transform"
