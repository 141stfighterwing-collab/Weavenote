      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg p-1">
        ...
        <div className="flex flex-wrap items-center gap-1 p-2 bg-slate-50 dark:bg-slate-900/50 border-b dark:border-slate-700 relative">
            ...
            <div className="flex gap-1 items-center relative">
                ...
                <button onClick={() => setShowEmojiPicker(!showEmojiPicker)} title="Insert Emoji" aria-label="Insert Emoji" className="p-1.5 hover:bg-white dark:hover:bg-slate-700 rounded text-base">😀</button>
                <button onClick={() => setShowColorPicker(!showColorPicker)} title="Text Color & Highlight" aria-label="Text Color & Highlight" className="p-1.5 hover:bg-white dark:hover:bg-slate-700 rounded text-base">🎨</button>
