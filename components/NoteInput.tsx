            ...
            <div className={`flex flex-col md:flex-row gap-4 h-[450px]`}>
                <div className="flex-1 flex flex-col min-w-0">
                    <div 
                        ...
                        onKeyDown={handleKeyDown} role="textbox" aria-multiline="true" aria-label="Main Note Editor"
                ...
                {activeType === 'code' && (
                    <div className="flex-1 flex flex-col min-w-0 animate-[fadeIn_0.3s_ease-out]">
                        ...
                        <div 
                            ...
                            onKeyDown={handleKeyDown} role="textbox" aria-multiline="true" aria-label="Code Snippet Editor"
