      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg p-1">
        ...
        <div className="flex flex-wrap items-center gap-1 p-2 bg-slate-50 dark:bg-slate-900/50 border-b dark:border-slate-700 relative">
            ...
            <div className="flex gap-1 items-center relative">
                <input type="file" id="file-upload" ref={fileInputRef} onChange={handleFileUpload} className="hidden" accept=".pdf,.txt,.md" />
                <button 
                ...
                <button onClick={() => setShowEmojiPicker(!showEmojiPicker)} aria-label="Insert Emoji" title="Insert Emoji" className="p-1.5 hover:bg-white dark:hover:bg-slate-700 rounded text-base">😀</button>
                <button onClick={() => setShowColorPicker(!showColorPicker)} aria-label="Text & Highlight Color" title="Text & Highlight Color" className="p-1.5 hover:bg-white dark:hover:bg-slate-700 rounded text-base">🎨</button>
                <button onClick={() => setShowGifPicker(!showGifPicker)} className="p-1.5 hover:bg-white dark:hover:bg-slate-700 rounded text-base" aria-label="Insert GIF" title="Insert GIF">🎬</button>
                <button onClick={() => setShowImageDialog(!showImageDialog)} className="p-1.5 hover:bg-white dark:hover:bg-slate-700 rounded text-base" aria-label="Insert Image URL" title="Insert Image URL">🖼️</button>
            ...
            <div className={`flex flex-col md:flex-row gap-4 h-[450px]`}>
                ...
                {activeType === 'code' && (
                    <div className="flex-1 flex flex-col min-w-0 animate-[fadeIn_0.3s_ease-out]">
                        <label htmlFor="code-snippet" className="block text-[10px] font-black uppercase tracking-widest text-slate-400 mb-2">Source Snippet (Black Box)</label>
                        <div 
                            id="code-snippet" ref={codeEditorRef} contentEditable
                            onKeyDown={handleKeyDown}
