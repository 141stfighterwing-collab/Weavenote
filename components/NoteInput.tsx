        ...
        <div className="flex flex-wrap items-center gap-1 p-2 bg-slate-50 dark:bg-slate-900/50 border-b dark:border-slate-700 relative">
            ...
            <div className="flex gap-1 items-center relative">
                ...
                <button 
                  ...
                  aria-label={isIngesting ? "Processing document" : "Ingest Document"}
                  title={isIngesting ? "Processing document" : "Ingest Document"}
                >
                ...
                <button onClick={() => setShowColorPicker(!showColorPicker)} className="p-1.5 hover:bg-white dark:hover:bg-slate-700 rounded text-base" aria-label="Change Color" title="Change Color">🎨</button>
