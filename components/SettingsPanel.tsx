...
import { getUserStats, UserUsageStats } from '../services/storageService';
...
const SettingsPanel: React.FC<SettingsPanelProps> = ({ 
  ...
  const [activeTab, setActiveTab] = useState<'requests' | 'users' | 'security' | 'ai-logs' | 'appearance'>('appearance');
  ...
  useEffect(() => {
    if (isOpen) {
        ...
        else if (activeTab === 'appearance') setActiveTab('requests');
        loadData();
    }
  }, [isOpen, isUserAdmin]);
