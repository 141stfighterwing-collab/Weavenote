...
export const NotebookView: React.FC<NotebookViewProps> = ({ 
  ...
  return (
    <div className="flex h-[calc(100vh-180px)] bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 overflow-hidden shadow-2xl animate-[fadeIn_0.3s_ease-out]">
      {/* Page Navigator */}
      <div className="w-72 border-r border-slate-200 dark:border-slate-700 flex flex-col bg-slate-50 dark:bg-slate-900/50">
